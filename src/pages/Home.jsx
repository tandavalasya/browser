...
const Home = () => (
  ...
  >
    <motion.div
      className="w-32 h-32 rounded-full bg-gradient-to-tr from-white via-pink-50 to-orange-100 flex items-center justify-center mb-4 shadow-xl border border-pink-200"
      animate={{ scale: [1, 1.08, 1] }}
      transition={{ repeat: Infinity, duration: 2 }}
    >
      <img src="/logo.png" alt="TandavaLasya Logo" className="w-28 h-28 object-contain drop-shadow-md" />
    </motion.div>
